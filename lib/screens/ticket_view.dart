...
import 'package:ticketsystem/utils/app_styles.dart';
import 'package:ticketsystem/widgets/column_layout.dart';
import 'package:ticketsystem/widgets/layout_builder_widget.dart';
import 'package:ticketsystem/widgets/thick_container.dart';
      ...
      child: Container(
        ...
        child: Column(
          children: [
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      SizedBox(
                        width:AppLayout.getHeight(100),child: Text(ticket['from']['name'],style: isColor==null? Styles.headLinestyle4.copyWith(color:Colors.white):Styles.headLinestyle4,),
                      ),

                      Text(ticket['flying_time'],style: isColor==null?Styles.headLinestyle4.copyWith(color: Colors.white):Styles.headLinestyle4),
                      SizedBox(
                        width:AppLayout.getHeight(100),child: Text(ticket['to']['name'],textAlign:TextAlign.end,style: isColor==null? Styles.headLinestyle4.copyWith(color:Colors.white):Styles.headLinestyle4,),
                      ),
                    ],
                  ),
                ],
            ...
            /*bottom part of orange ticket/card*/
            Container(
              decoration:  BoxDecoration(
                  color: isColor==null?Styles.orangeColor:Colors.white,
                  ...
                  Row(
                    ...
                    children: [
                      AppColumnLayout(firstText: ticket['date'],
                          secondText: "Date",
                          alignment: CrossAxisAlignment.start, isColor: isColor, firsttext: null,),
                      AppColumnLayout(firstText: ticket['departure_time'],
                          secondText: "Departure Time",
                          alignment: CrossAxisAlignment.center, isColor: isColor, firsttext: null,),
                      AppColumnLayout(firstText: ticket['number'].toString(),
                          secondText: "Number",
                          alignment: CrossAxisAlignment.end, isColor: isColor, firsttext: null,),
